...
<!--	xmlns:msxsl="http://exslt.org/common" -->
	...
	<xsl:template name="EXPLANATORY_NOTES">
		...
		<div id="section-one">
			...
			<div style="text-align: justify" id="explanatory_note"><span style="text-align:justify;font:arial:font-size:9pt;margin-bottom:5px;">This edition of
	...
	<xsl:template name="miscellneous-section">
		...
		<div>
			...
			<hr
				style="height:1px;border:none;color:#000;background-color:#000; width:130px;line-height:0%;"/><br/>
			<p style="text-align:center;font:arial;font-size:9pt;margin-top:0px;margin-bottom:0px;">
...
<!--					<td width="13.1%" style="vertical-align:text-top;"><i></i></td>-->
		...
		<span style="text-align:left; margin-bottom:0px;margin-top:0px;">
			<b><xsl:value-of select="concat($encw-count,'Permanently Withdrawn')"/></b><!--<br/><br/>-->
...
<!-\-									<xsl:value-of select="CHART_NUM"/>-\->
	...
	<xsl:template name="generate-hydrographic-note">
		...
		<div>
			...
			<table style="width:100%;margin-top:6px;margin-bottom:6px;background-color:silver;border-top:1px solid black;border-bottom:1px solid black;">
					<tr>
	...
	<xsl:template match="NM_LIGHT_LIST_RECORD">
		...
		<tr style="vertical-align:text-top;">
			...
			<td style="width:20%;"><!--<p style="margin-left: 15px"><xsl:copy-of select="NM_REMARKS"/></p>--><xsl:copy-of select="NM_REMARKS"/>
	...
	<xsl:template match="NM_CHART_SECTION" name="nm_chart_section">
		...
		<div>
			...
			<div style="padding-left:50px; text-align:center;">
				<table style="margin-left:1.65in;mso-padding-left-alt:5.0pt;align:center;padding:0px;margin-bottom:50%;">
					<tr>
	...
	<xsl:template match="NM_CHART_NTC">
			...
			<table>
				<tr>
					...
					<td style="margin-top:15pt;vertical-align:text-top;width:86%">
						<b>
							<xsl:if test="normalize-space(NZ_LOCALITY)">
								<xsl:value-of select="normalize-space(NZ_LOCALITY)"/>
								<xsl:text> </xsl:text>
...
-->		</ol>
		...
		<xsl:call-template name="OutputChartInstructions">
			<!--<xsl:with-param name="ChartInstructions" select="msxsl:node-set($nm-chart-instructions)/NM_CHARTINSTRUCT"/>-->
